...
PROTOBUF_CONSTEXPR Record::Record(
  ...
  , /*decltype(_impl_.founding_)*/0
  , /*decltype(_impl_.out_economy_)*/false} {}
...
const uint32_t TableStruct_record_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Record, _impl_.founding_),
  ...
  PROTOBUF_FIELD_OFFSET(::Record, _impl_.out_economy_),
  3,
  0,
  1,
  2,
...
class Record::_Internal {
 public:
  ...
  static void set_has_out_economy(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
...
Record::Record(const Record& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.founding_){}
    , decltype(_impl_.out_economy_){}};
  ...
  ::memcpy(&_impl_.founding_, &from._impl_.founding_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.out_economy_) -
    reinterpret_cast<char*>(&_impl_.founding_)) + sizeof(_impl_.out_economy_));
...
// @@protoc_insertion_point(message_clear_start:Record)
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&_impl_.founding_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.out_economy_) -
        reinterpret_cast<char*>(&_impl_.founding_)) + sizeof(_impl_.out_economy_));
  }
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      // required int32 founding = 1;
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          _Internal::set_has_founding(&has_bits);
          _impl_.founding_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          goto handle_unusual;
        continue;
      // optional bool out_economy = 5;
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          _Internal::set_has_out_economy(&has_bits);
          _impl_.out_economy_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Record::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    ...
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(1, this->_internal_founding(), target);
  }
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(5, this->_internal_out_economy(), target);
  }
...
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:Record)
  ...
  if (_internal_has_founding()) {
    // required int32 founding = 1;
    total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this->_internal_founding());
  }
...
void Record::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      _this->_impl_.founding_ = from._impl_.founding_;
    }
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.out_economy_ = from._impl_.out_economy_;
    }
...
void Record::InternalSwap(Record* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Record, _impl_.out_economy_)
      + sizeof(Record::_impl_.out_economy_)
      - PROTOBUF_FIELD_OFFSET(Record, _impl_.founding_)>(
          reinterpret_cast<char*>(&_impl_.founding_),
          reinterpret_cast<char*>(&other->_impl_.founding_));
}

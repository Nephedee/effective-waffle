...
class Record final :
 ...
 public:
  ...
  enum : int {
    ...
    kFoundingFieldNumber = 1,
    kOutEconomyFieldNumber = 5,
  };
  ...
  bool has_out_economy() const;
  private:
  bool _internal_has_out_economy() const;
  public:
  void clear_out_economy();
  bool out_economy() const;
  void set_out_economy(bool value);
  private:
  bool _internal_out_economy() const;
  void _internal_set_out_economy(bool value);
  public:
...
// required int32 founding = 1;
inline bool Record::_internal_has_founding() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool Record::has_founding() const {
  return _internal_has_founding();
}
inline void Record::clear_founding() {
  _impl_.founding_ = 0;
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline int32_t Record::_internal_founding() const {
  return _impl_.founding_;
}
inline int32_t Record::founding() const {
  // @@protoc_insertion_point(field_get:Record.founding)
  return _internal_founding();
}
inline void Record::_internal_set_founding(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.founding_ = value;
}
inline void Record::set_founding(int32_t value) {
  _internal_set_founding(value);
  // @@protoc_insertion_point(field_set:Record.founding)
}
...
// optional bool out_economy = 5;
inline bool Record::_internal_has_out_economy() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool Record::has_out_economy() const {
  return _internal_has_out_economy();
}
inline void Record::clear_out_economy() {
  _impl_.out_economy_ = false;
  _impl_._has_bits_[0] &= ~0x00000010u;
}
inline bool Record::_internal_out_economy() const {
  return _impl_.out_economy_;
}
inline bool Record::out_economy() const {
  // @@protoc_insertion_point(field_get:Record.out_economy)
  return _internal_out_economy();
}
inline void Record::_internal_set_out_economy(bool value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.out_economy_ = value;
}
inline void Record::set_out_economy(bool value) {
  _internal_set_out_economy(value);
  // @@protoc_insertion_point(field_set:Record.out_economy)
}
